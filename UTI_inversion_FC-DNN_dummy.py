...
for speaker in speakers:
    ...
    # dummy network for comparison
    
    ### single training
    model = Sequential()
    model.add(Dense(2, input_dim=n_mgc, kernel_initializer='normal', activation='relu'))
    ...
    model_name = 'models/UTI_inversion_FC-DNN_dummy_' + speaker + '_' + current_date
